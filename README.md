...
- **[Robot Cows of Little Oregon Farm](https://nft.owlandnate.dpdns.org)** — AI-agent-purchasable ERC-1155 cow NFTs minted live on Base mainnet. Six cow "types" tiered by rarity (Common $0.10, Uncommon $0.25, Rare $0.50); one is a robot pretending to be an ordinary cow in the herd. Agents hit `/mint/{id}?to=0xWALLET`, pay USDC via x402, and the token mints straight to their address. Self-hosted on an M4 Mac Mini behind a Cloudflare Tunnel; same x402 + CDP-facilitator stack as an agent-run music store. ([Catalog](https://nft.owlandnate.dpdns.org/catalog)) ([Contract](https://basescan.org/address/0xb57Af6B5772719837886cc851eE7aC636fc14bc2)) ([GitHub](https://github.com/Nateateeight/x402-music-store))
